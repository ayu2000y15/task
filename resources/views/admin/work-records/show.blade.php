            ...
            <div class="overflow-x-auto h-[75vh] overflow-y-auto">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 relative">
                    <thead class="bg-gray-50 dark:bg-gray-700">
                        <tr>
                            {{-- ▼▼▼【ここを修正】各ヘッダーセル(th)にstickyクラスを追加 ▼▼▼ --}}
                            <th
                        ...
                        @forelse ($monthlyReport as $day)
                            @if($day['type'] === 'workday')
                                ...
                                <tr class="summary-row hover:bg-gray-50 dark:hover:bg-gray-700/50"
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap font-semibold">
                                        {{ gmdate('H:i:s', $day['total_work_seconds']) }}
                                    </td>
                            ...
                            @else
                                ...
                                <tr class="bg-gray-50/50 dark:bg-gray-800/30">
                                    <td class="px-6 py-4 whitespace-nowrap text-gray-500">{{ $day['date']->format('n/j (D)') }}</td>
                                    <td colspan="1" class="px-6 py-4 text-gray-400 dark:text-gray-500 text-sm">休み</td>
                                </tr>
                            @endif
                        @empty
                            <tr>
                                <td colspan="8" class="px-6 py-12 text-center text-sm text-gray-500">この月の作業実績はありません。</td>
                            </tr>
                        @endforelse
                    </tbody>
                    {{-- 月の合計フッター --}}
                    <tfoot class="bg-gray-100 dark:bg-gray-700 sticky bottom-0">
                        <tr class="border-t-2 border-gray-300 dark:border-gray-600 font-bold">
                            ...
                            <td class="px-6 py-3 text-left whitespace-nowrap">{{ gmdate('H:i:s', $monthTotalWorkSeconds) }}
                            </td>
