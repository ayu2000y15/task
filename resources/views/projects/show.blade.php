                                ...
                                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 overflow-hidden js-character-card" >
                                    ...
                                    <div class="p-1 sm:p-2">
                                        ...
                                        <div class="py-3">
                                            ...
                                            @can('manageMaterials', $project)<div x-show="activeCharacterTab[{{ $character->id }}] === 'materials-{{ $character->id }}'" id="materials-content-{{ $character->id }}" style="display: none;">@include('projects.partials.character-materials-tailwind', ['character' => $character, 'project' => $project, 'availableInventoryItems' => $availableInventoryItems])</div>@endcan
