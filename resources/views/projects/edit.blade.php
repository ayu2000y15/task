...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            ...
            <form action="{{ route('projects.destroy', $project) }}" method="POST" class="d-inline" onsubmit="return confirm('本当に削除しますか？プロジェクト内のすべてのタスクも削除されます。');">
                @csrf
                @method('DELETE')
            ...
            <form action="{{ route('projects.update', $project) }}" method="POST" class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        <input type="color" class="form-control form-control-color" id="color" name="color" value="{{ old('color', $project->color) }}">
                        <input type="text" class="form-control" id="colorHex" value="{{ old('color', $project->color) }}" readonly>
                    </div>
                </div>
