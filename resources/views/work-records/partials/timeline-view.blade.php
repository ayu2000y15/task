...
<div class="bg-white dark:bg-gray-800 shadow-md rounded-lg">
    ...
    <div class="p-6 space-y-8">
        @forelse ($timelineItems as $item)
            <div class="flex">
                <div class="w-28 text-right pr-4 flex-shrink-0">
                    <p class="font-mono text-sm text-gray-800 dark:text-gray-200">{{ $item->timestamp->format('H:i') }}</p>
                </div>
                <div class="relative px-4">
                    <div class="absolute top-0 left-1/2 w-0.5 h-full bg-gray-200 dark:bg-gray-700 -translate-x-1/2"></div>
                    <div
                        class="absolute top-1 left-1/2 w-5 h-5 bg-white dark:bg-gray-800 rounded-full border-2 flex items-center justify-center -translate-x-1/2">
