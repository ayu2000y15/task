...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'activitylog.dispatches_events' => 'boolean',
            'activitylog.model' => 'string',
            'activitylog.activity_model_uses_uuid' => 'boolean',
            'activitylog.causer_model_uses_uuid' => 'boolean',
            'activitylog.subject_as_relation' => 'boolean',
            'activitylog.causer_as_relation' => 'boolean',
            'activitylog.properties_as_relation' => 'boolean',
            'activitylog.default_log_options' => 'NULL',
            'app.name' => 'string',
            'app.env' => 'string',
            'app.debug' => 'boolean',
            'app.url' => 'string',
            ...
            'filesystems.links.C:\Users\ayu20\OneDrive\デスクトップ\cosplatform\開発関連\アプリ開発\02.受注管理システム\task\public\storage' => 'string',
            ...
            'project_forms.default_custom_fields.0.name' => 'string',
            'project_forms.default_custom_fields.0.label' => 'string',
            'project_forms.default_custom_fields.0.type' => 'string',
            'project_forms.default_custom_fields.0.required' => 'boolean',
            'project_forms.default_custom_fields.0.order' => 'integer',
            'project_forms.default_custom_fields.0.placeholder' => 'string',
            'project_forms.default_custom_fields.0.options' => 'string',
            'project_forms.default_custom_fields.0.maxlength' => 'integer',
            'project_forms.default_custom_fields.1.name' => 'string',
            'project_forms.default_custom_fields.1.label' => 'string',
            'project_forms.default_custom_fields.1.type' => 'string',
            'project_forms.default_custom_fields.1.required' => 'boolean',
            'project_forms.default_custom_fields.1.order' => 'integer',
            'project_forms.default_custom_fields.1.placeholder' => 'string',
            'project_forms.default_custom_fields.1.options' => 'string',
            'project_forms.default_custom_fields.1.maxlength' => 'integer',
...
'tools.viewAnyPage','tools.sales.access','viewAny','view','create',
'update','delete','manageMeasurements','manageMeasurementTemplates','updateMeasurements',
'updateMeasurementTemplates','deleteMeasurements','deleteMeasurementTemplates','manageMaterials','updateMaterials',
'deleteMaterials','manageCosts','updateCosts','deleteCosts','viewFormDefinition',
'updateFormDefinition','deleteFormDefinition','viewAnyFileFolders','canCreateFoldersForFileUpload','fileView',
'fileDownload','fileUpload','denyWithStatus','denyAsNotFound','reorder',
'stockIn','adjustStock','updateStatus','viewAnyTools','accessSalesTool',);
...
'activitylog.activity_model','activitylog.table_name','activitylog.database_connection','activitylog.dispatches_events','activitylog.model',
'activitylog.activity_model_uses_uuid','activitylog.causer_model_uses_uuid','activitylog.subject_as_relation','activitylog.causer_as_relation','activitylog.properties_as_relation',
'activitylog.default_log_options','app.name','app.env','app.debug','app.url',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Users\\ayu20\\OneDrive\\デスクトップ\\cosplatform\\開発関連\\アプリ開発\\02.受注管理システム\\task\\public\\storage',
...
'mail.markdown.theme','mail.markdown.paths','project_forms.default_custom_fields.0.name','project_forms.default_custom_fields.0.label','project_forms.default_custom_fields.0.type',
'project_forms.default_custom_fields.0.required','project_forms.default_custom_fields.0.order','project_forms.default_custom_fields.0.placeholder','project_forms.default_custom_fields.0.options','project_forms.default_custom_fields.0.maxlength',
'project_forms.default_custom_fields.1.name','project_forms.default_custom_fields.1.label','project_forms.default_custom_fields.1.type','project_forms.default_custom_fields.1.required','project_forms.default_custom_fields.1.order',
'project_forms.default_custom_fields.1.placeholder','project_forms.default_custom_fields.1.options','project_forms.default_custom_fields.1.maxlength','queue.default','queue.connections.sync.driver',
...
'debugbar.queries.explain','home.index','dashboard','projects.index',
'projects.create','projects.store','projects.show','projects.edit','projects.update',
'projects.destroy','tasks.assignee','projects.updateDeliveryFlag','projects.updatePaymentFlag','projects.updateStatus',
'profile.edit','profile.update','profile.destroy','tasks.index','projects.tasks.create',
'projects.tasks.store','projects.tasks.show','projects.tasks.edit','projects.tasks.update','projects.tasks.destroy',
'projects.tasks.fromTemplate','tasks.update_progress','tasks.update_position','tasks.update_parent','projects.tasks.description.update',
'projects.tasks.files.upload','projects.tasks.files.index','projects.tasks.files.download','projects.tasks.files.show','projects.tasks.files.destroy',
'gantt.index','calendar.index','projects.characters.measurements.store','projects.characters.measurements.update','projects.characters.measurements.destroy',
'projects.characters.measurement-templates.index','projects.characters.measurement-templates.store','measurement-templates.load','measurement-templates.destroy','projects.characters.materials.store',
'projects.characters.materials.update','projects.characters.materials.destroy','projects.characters.costs.store','projects.characters.costs.update','projects.characters.costs.destroy',
'projects.characters.store','characters.edit','characters.update','characters.destroy','projects.characters.costs.partial',
'user_feedbacks.create','user_feedbacks.store','admin.form-definitions.index','admin.form-definitions.create','admin.form-definitions.store',
'admin.form-definitions.edit','admin.form-definitions.update','admin.form-definitions.destroy','admin.form-definitions.reorder','admin.process-templates.index',
'admin.process-templates.create','admin.process-templates.store','admin.process-templates.show','admin.process-templates.edit','admin.process-templates.update',
'admin.process-templates.destroy','admin.process-templates.items.store','admin.process-templates.items.destroy','admin.process-templates.items.update','admin.measurement-templates.index',
'admin.measurement-templates.create','admin.measurement-templates.store','admin.measurement-templates.edit','admin.measurement-templates.update','admin.measurement-templates.destroy',
'admin.users.index','admin.users.edit','admin.users.update','admin.roles.index','admin.roles.create',
'admin.roles.store','admin.roles.show','admin.roles.edit','admin.roles.update','admin.roles.destroy',
'admin.roles.update','admin.feedbacks.index','admin.feedbacks.edit','admin.feedbacks.update','admin.feedbacks.updateStatus',
'admin.feedbacks.updateMemo','admin.feedbacks.updateAssignee','admin.feedback-categories.index','admin.feedback-categories.create','admin.feedback-categories.store',
'admin.feedback-categories.edit','admin.feedback-categories.update','admin.feedback-categories.destroy','admin.feedback-categories.reorder','admin.inventory.index',
'admin.inventory.create','admin.inventory.store','admin.inventory.show','admin.inventory.edit','admin.inventory.update',
'admin.inventory.destroy','admin.inventory.stockIn','admin.inventory.adjustStock','admin.stock-orders.index','admin.stock-orders.create',
'admin.stock-orders.store','admin.stock-orders.show','admin.stock-orders.edit','admin.stock-orders.update','admin.stock-orders.destroy',
'admin.stock-orders.updateStatus','admin.inventory-logs.index','admin.logs.index','admin.external-submissions.index','admin.external-submissions.updateStatus',
'admin.external-submissions.show','admin.external-requests.index','tools.index','tools.sales.index','tools.sales.email-lists.index',
'tools.sales.email-lists.create','tools.sales.email-lists.store','tools.sales.email-lists.edit','tools.sales.email-lists.update','tools.sales.email-lists.destroy',
'tools.sales.email-lists.show','tools.sales.email-lists.subscribers.create','tools.sales.email-lists.subscribers.store','tools.sales.email-lists.subscribers.edit','tools.sales.email-lists.subscribers.update',
'tools.sales.email-lists.subscribers.destroy','tools.sales.emails.compose','tools.sales.emails.send','tools.sales.emails.uploadImage','tools.sales.emails.sent.index',
'tools.sales.emails.sent.show','tools.sales.blacklist.index','tools.sales.blacklist.store','tools.sales.blacklist.destroy','tools.sales.settings.edit',
'tools.sales.settings.update','external-form.create','external-form.store','external-form.thanks','register','login','password.request','password.email',
...
'admin.external_submissions.index','admin.external_submissions.show','admin.feedback_categories.create','admin.feedback_categories.edit','admin.feedback_categories.index',
'admin.feedbacks.edit','admin.feedbacks.index','admin.form_definitions._form','admin.form_definitions.create','admin.form_definitions.edit',
'admin.form_definitions.index','admin.inventory.create','admin.inventory.edit','admin.inventory.index','admin.inventory_logs.index',
'admin.logs.index','admin.measurement-templates.create','admin.measurement-templates.edit','admin.measurement-templates.index','admin.process_templates.create',
'admin.process_templates.index','admin.process_templates.show','admin.roles.create','admin.roles.index','admin.stock_orders.create',
'admin.stock_orders.edit','admin.stock_orders.index','admin.stock_orders.show','admin.users.edit','admin.users.index',
'auth.confirm-password','auth.forgot-password','auth.login','auth.register','auth.reset-password',
'auth.verify-email','calendar.index','characters.edit','components.application-logo','components.auth-session-status',
'components.checkbox-input','components.danger-button','components.dropdown','components.dropdown-link','components.feedback-filter-panel',
'components.filter-panel','components.icon-button','components.input-error','components.input-label','components.modal',
'components.nav-link','components.primary-button','components.radio-input','components.responsive-nav-link','components.secondary-button',
'components.select-input','components.text-input','components.textarea-input','emails.reset-password','emails.verify-email',
'external_form.form','external_form.thanks','gantt.index','gantt.partials.task_rows','home.index',
'layouts.admin','layouts.app','layouts.guest','layouts.login','layouts.mail',
'layouts.navigation','layouts.tool','mail','mail_kanri','pagination::bootstrap-4',
...
'profile.partials.update-password-form','profile.partials.update-profile-information-form','projects.create','projects.edit','projects.index',
'projects.partials.character-costs-tailwind','projects.partials.character-materials-tailwind','projects.partials.character-measurements-tailwind','projects.partials.character-tasks-tailwind','projects.partials.form-fields',
'projects.partials.projects-task-table','projects.show','tasks.create','tasks.edit','tasks.index',
'tasks.partials.character-tasks-tailwind','tasks.partials.file-list-tailwind','tasks.partials.task-table','tools.index','tools.sales.blacklist.index',
'tools.sales.email_lists.create','tools.sales.email_lists.edit','tools.sales.email_lists.index','tools.sales.email_lists.show','tools.sales.emails.compose',
'tools.sales.emails.sent.index','tools.sales.emails.sent.show','tools.sales.index','tools.sales.settings.edit','tools.sales.subscribers.create',
'tools.sales.subscribers.edit','user_feedbacks.create','vendor.pagination.bootstrap-4','vendor.pagination.bootstrap-5','vendor.pagination.default',
...
'vendor.pagination.tailwind','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor','laravel-exceptions-renderer::components.header',
...
'validation.uuid','validation.custom.attribute-name.rule-name','pagination.showing','validation.password','validation.custom.属性名.ルール名',
'validation.attributes.name','validation.attributes.description','validation.attributes.start_date','validation.attributes.end_date','validation.attributes.duration',
'validation.attributes.assignee','validation.attributes.parent_id','validation.attributes.status','validation.attributes.color','validation.attributes.is_milestone',
'validation.attributes.is_folder',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_TIMEZONE',
'APP_URL','DEBUGBAR_ENABLED','DEBUGBAR_COLLECTORS_GATE','DEBUGBAR_OPTIONS_GATE_TRACE','QUEUE_CONNECTION',
